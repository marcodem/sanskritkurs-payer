...
### Segunda regra para a formação de ligaduras consonânticas

\[Primeira regra, ver em [Exercício de Escrita 8](schrift08.md)\]

Se o primeiro dos consonantes a serem unidos não terminar com uma linha vertical, então o seguinte é colocado sob o primeiro consonante, perdendo sua linha horizontal.

Exceções: Se ⟪म्⟫ ou ⟪य्⟫ forem o segundo membro da ligadura, eles são escritos abreviados após o primeiro caractere:
...
Exemplos (as exceções estão sublinhadas):
...
Escreva todas as ligaduras mencionadas acima

### Índice das ligaduras mais comuns na fonte tipográfica da Gramática de Kielhorn
