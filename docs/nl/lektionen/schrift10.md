...
### Tweede regel voor de vorming van consonantenligaturen

\[Eerste regel zie in [Schrijfoefening 8](schrift08.md)\]

Wanneer de eerste van de te verbinden consonanten niet met een verticale streep eindigt, dan wordt de volgende consonant, met verlies van zijn horizontale streep, onder de eerste consonant geplaatst.

Uitzonderingen: Zijn ⟪म्⟫ respectievelijk ⟪य्⟫ het tweede lid van de ligatuur, dan worden zij verkort achter het eerste teken geschreven:
...
Voorbeelden (uitzonderingen zijn onderstreept):
...
Schrijf alle hierboven vermelde ligaturen

### Overzicht van de meest gebruikte ligaturen in het schrifttype van Kielhorns Grammatica
